...
type SysUser struct {
	...
	LoginName     string    `gorm:"column:login_name;not null;comment:用户昵称" json:"login_name"`    // 用户昵称
	...
	Salt          string    `gorm:"column:salt;comment:密码" json:"salt"`                           // 密码
	...
	PwdUpdateDate time.Time `gorm:"column:pwd_update_date;comment:最后登录时间" json:"pwd_update_date"` // 最后登录时间
